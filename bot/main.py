...
async def main() -> None:
    ...
    # Register bot commands for side menu
    commands = [
        BotCommand(command="rent", description="Вопросы по аренде недвижимости"),
        BotCommand(command="buy", description="Покупка и продажа недвижимости"),
